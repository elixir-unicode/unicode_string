defmodule Unicode.String.Break.Sentence do
  ...
  @deprecated "Use Unicode.String.Dfa.Sentence.next/3 instead"
  defdelegate next(string, locale, suppressions), to: Dfa.Sentence

  @doc "Splits `string` into sentences under `locale`."
  @deprecated "Use Unicode.String.Dfa.Sentence.split/3 instead"
  ...
  @deprecated "Use Unicode.String.Dfa.Sentence.break?/4 instead"
