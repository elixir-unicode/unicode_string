defmodule Unicode.String.Break.Grapheme do
  @moduledoc """
  Deprecated. Use `Unicode.String.Dfa.Grapheme` instead. This module is removed
  in 2.5.0.
  ...
  @deprecated "Use Unicode.String.Dfa.Grapheme.next/1 instead. Removed in 2.5.0"
  defdelegate next(string), to: Dfa.Grapheme

  @doc "Splits `string` into segments."
  @deprecated "Use Unicode.String.Dfa.Grapheme.split/1 instead. Removed in 2.5.0"
  defdelegate split(string), to: Dfa.Grapheme, as: :split

  @doc "Returns `true` when a boundary falls between the two strings."
  @deprecated "Use Unicode.String.Dfa.Grapheme.break?/2 instead. Removed in 2.5.0"
