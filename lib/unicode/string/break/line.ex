defmodule Unicode.String.Break.Line do
  @moduledoc """
  Deprecated. Use `Unicode.String.Dfa.Line` instead. This module is removed
  in 2.5.0.
  ...
  @deprecated "Use Unicode.String.Dfa.Line.next/1 instead. Removed in 2.5.0"
  defdelegate next(string), to: Dfa.Line

  @doc "Splits `string` into segments."
  @deprecated "Use Unicode.String.Dfa.Line.rule_split/1 instead. Removed in 2.5.0"
  defdelegate split(string), to: Dfa.Line, as: :rule_split

  @doc "Returns `true` when a boundary falls between the two strings."
  @deprecated "Use Unicode.String.Dfa.Line.break?/2 instead. Removed in 2.5.0"
